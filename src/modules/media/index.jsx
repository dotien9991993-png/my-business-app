...
export default function MediaModule() {
  ...
  const {
    ...
    taskFilterProduct, setTaskFilterProduct, taskFilterParticipant, setTaskFilterParticipant, taskSortBy, setTaskSortBy,
